...
def base_calc(num) :
        ...
        if num[1] == "B" :
                ...
                return( "Decimal = {x}".format( x = hex_final ) ,"Binary = {y}".format( y = hex_bin ), "Octal = {z}".format( z = hex_oct ) )

        else :
                dec_bin = decbin( int(num) )
                dec_oct = decoct( int(num) )
                dec_hex = dechex( int(num) )

                return( "Binary = {x}".format( x = dec_bin ) ,"Octal = {y}".format( y = dec_oct ), "Hexadecimal = {z}".format( z = dec_hex ) )
# ---------------------------------------------------------------------------------
